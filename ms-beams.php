  ...
  <main>
    ...
    <section class="py-16 md:py-24 bg-gray-50/50">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
              ...
              <tbody class="divide-y divide-gray-100">
                <!-- Data Rows -->
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">100 x 50 STD</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">8.9</td><td class="px-6 py-3 text-gray-600 text-center">2.7</td></tr>
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">100 x 50 MED</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">7</td><td class="px-6 py-3 text-gray-600 text-center">2.1</td></tr>
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">100 x 50 LIGHT</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">5.3</td><td class="px-6 py-3 text-gray-600 text-center">1.6</td></tr>
                <tr class="bg-gray-50/30 hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">125 x 70 STD</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">13.3</td><td class="px-6 py-3 text-gray-600 text-center">4.05</td></tr>
                <tr class="bg-gray-50/30 hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">125 x 70 MED</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">11.5</td><td class="px-6 py-3 text-gray-600 text-center">3.5</td></tr>
                <tr class="bg-gray-50/30 hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">125 x 70 LIGHT</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">9</td><td class="px-6 py-3 text-gray-600 text-center">2.7</td></tr>
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">140 x 70</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">24</td><td class="px-6 py-3 text-gray-600 text-center">7.31</td></tr>
                <tr class="bg-gray-50/30 hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">150 x 75 STD</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">15</td><td class="px-6 py-3 text-gray-600 text-center">4.6</td></tr>
                <tr class="bg-gray-50/30 hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">150 x 75 LIGHT</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">13.5</td><td class="px-6 py-3 text-gray-600 text-center">4.1</td></tr>
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">175 x 85</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">19.6</td><td class="px-6 py-3 text-gray-600 text-center">6</td></tr>
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group"><td class="px-6 py-3 whitespace-nowrap font-medium text-gray-900 border-r border-gray-400">200 x 100</td><td class="px-6 py-3 text-gray-600 text-center border-r border-gray-400">24.2</td><td class="px-6 py-3 text-gray-600 text-center">7.4</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-400 fade-up mb-12 max-w-5xl mx-auto" style="transition-delay: 0.3s;">
          <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
              <thead>
                <tr class="bg-gray-200/80 border-b border-gray-400">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group">
                  <td class="px-6 py-4 text-gray-700 max-w-xs border-r border-gray-400 leading-relaxed">
                  ...
                  <td class="px-6 py-0 p-0 border-r border-gray-400 align-top">
                    <table class="w-full h-full">
                       <tr class="border-b border-gray-400 border-dashed">
                  ...
                  <td class="px-6 py-4 text-gray-700 whitespace-nowrap border-r border-gray-400 align-top">&plusmn; 2.5 %</td>
