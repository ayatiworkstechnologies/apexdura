    ...
    <section class="py-16 md:py-24 bg-gray-50/50">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="bg-red-50/50 border border-red-100 rounded-2xl p-8 md:p-10 text-center fade-up" style="transition-delay: 0.4s;">
          ...
          <a href="customize-products" class="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white bg-red-600 rounded-xl hover:bg-red-700 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 focus:ring-4 focus:ring-red-100 whitespace-nowrap">
